...
class HiringManagerAddRequirement extends StatefulWidget {
  ...
  HiringManagerAddRequirement(this.requirement, this.addOrEdit);

  @override
  State<StatefulWidget> createState() {
    return HiringManagerAddRequirementState(this.requirement, this.addOrEdit);
  }
}
...
class HiringManagerAddRequirementState
  ...
  HiringManagerAddRequirementState(this.requirement, this.addOrEdit);
